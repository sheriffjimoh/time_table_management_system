...
<div id="myModal" class="modal">
    ...
    <!-- Modal content -->
    <div class="modal-content" style="margin-top: -90px; overflow-y:scroll; height: 540px ">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="facultyno" value="<?php  echo 'COM'.rand(3564,8568); ?>" name="TF" placeholder="Faculty No ...">
                    </div>
                    <div class="form-group">
