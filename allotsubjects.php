...
<br>
<div align="center">
    <form action="allotmentFormvalidation.php" method="post"   style="display: flex;margin-top: 100px ; flex-direction: row; justify-content: center; align-content: center;">
        ...
        <div style=" margin-right: 5px">
         ...
         <option selected disabled>Select Subject</option>';
                    while ($row = mysqli_fetch_assoc($q)) {
                        if ($row['isAlloted'] == 1 || $row['course_type'] == $_GET["type"])
                            continue;
...
<table id=allotedsubjectstable>
    ...
    while ($row = mysqli_fetch_assoc($q)) {
        if ($row['isAlloted'] == 0 || $row['course_type'] == 'THEORY')
            continue;
